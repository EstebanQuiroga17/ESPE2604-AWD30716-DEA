...
import type { SRIFactura } from './xmlParser.service';
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerContainer}>
          ...
          <View style={styles.companyBox}>
            ...
            <Text style={{ marginBottom: 3, flexWrap: 'wrap' }}>
              <Text style={styles.bold}>Dirección Matriz: </Text>
              {factura.infoTributaria.dirMatriz}
            </Text>
          ...
          <View style={styles.sriBox}>
            ...
            <Text style={styles.title}>{factura.tipoDocumento || 'FACTURA'}</Text>
            <Text style={{ marginBottom: 3, flexWrap: 'wrap' }}>
