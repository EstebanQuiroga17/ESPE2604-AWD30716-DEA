...
export class InvoicesRepoController {
  ...
  public async filterInvoices(req: Request, res: Response): Promise<void> {
    try {
  ...
  public async countUserInvoices(req: Request, res: Response): Promise<void> {
    try {
      const count = await prisma.invoice.count({ where: { taxpayerId: req.params.userId as string } });
  ...
  public async saveBulkInvoices(req: Request, res: Response): Promise<void> {
    try {
